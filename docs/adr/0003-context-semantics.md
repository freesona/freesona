...
**Date**: 2026-07-18  
**Supersedes**: N/A  
**Related**: ADR-0001 (PromptBuilder Architecture), ADR-0002 (ConversationManager)
...
> **Rationale for Priority 25**: Canon sits between System (hard constraints) and Persona (identity expression). It provides the *why* that Persona expresses as *what*. This ordering ensures model sees: Constraints → Reasoning → Identity → Context.
