...
def build_response(text: str) -> ConversationResponse:
    """Construct a ConversationResponse from generated text.

    Args:
        text: The raw text generated by the AI provider.

    Returns:
        ConversationResponse object containing the split segments.
    """
...
async def send_response(
    ...
    *,
    ...
    """Send a formatted response to a Discord channel.

    Args:
        response: ConversationResponse containing message segments.
        channel: Discord channel or messageable target.
...
async def extract_attachments(
    ...
    Args:
        message: Discord message object possibly containing attachments.

    Returns:
        List of (bytes, mime_type) tuples for each attachment.
    """
...
async def safe_generate(*args, **kwargs) -> ConversationResponse:
    """Safely generate a response, handling provider errors.

    Args:
        *args, **kwargs: Passed through to the underlying generate function.

    Returns:
        ConversationResponse containing the generated text or an error message.
    """
    try:
