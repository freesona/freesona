...
def setup_logging(bot: Optional[Client] = None) -> logging.Logger:
    ...
    # Remove only handlers added by this module (marked with _freesona_handler)
    for handler in root_logger.handlers[:]:
        if getattr(handler, "_freesona_handler", False):
    ...
    console_handler._freesona_handler = True  # Mark as our handler
    ...
    try:
        ...
        file_handler._freesona_handler = True
    ...
    if log_include_discord and bot and log_channel_id:
        ...
        discord_handler._freesona_handler = True
