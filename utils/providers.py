...
def generate_text(
    ...
    *,
    ...
    model_name = (
        model or get_provider_model() or get_model_name()
    ).strip() or get_model_name()
    ...
    if provider_name == "gemini":
        ...
        # System instruction is a top-level parameter (not in
        # generation_config)
    ...
    if provider_name == "openai":
        ...
        headers = {
            ...
            "Content-Type": OPENAI_COMPATIBLE_CONTENT_TYPE,
        }
        return (
