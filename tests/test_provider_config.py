...
class ProviderConfigTests(unittest.TestCase):
    ...
    def test_model_name_defaults(self):
        self.assertEqual(self.config_module.get_model_name(), "gemini-flash-lite-latest")
    ...
    def test_embed_footer(self):
        ...
        # Test truncation
        long_query = "a" * 100
        footer_truncated = self.config_module.embed_footer("Alice", long_query, max_query_len=20)
        self.assertTrue(footer_truncated.endswith("…"))
        self.assertEqual(len(footer_truncated), len("Asked by Alice  •  ") + 20)
